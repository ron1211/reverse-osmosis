...
- (void)setupView {
    ...
    [self.pageControl setPageIndicatorTintColor:[UIColor colorWithRed:0/255.0 green:53.0/255.0 blue:130.0/255.0 alpha:1.0]];
    [self.pageControl setCurrentPageIndicatorTintColor:[UIColor colorWithRed:255.0/255.0 green:245.0/255.0 blue:155.0/255.0 alpha:1.0]];
    ...
    [self.rightButton setBackgroundImage:[UIImage imageNamed:@"skipIntroNon.png"] forState:UIControlStateNormal];
    //[self.leftButton addTarget:self action:@selector(didClickOnButton1:)            forControlEvents:UIControlEventTouchUpInside];
...
- (void)addAllConstraints {
    ...
    NSDictionary *views = NSDictionaryOfVariableBindings(_overlayTitle, _rightButton, _pageControl, _gradientView);
    ...
    [constraints addObject:@"V:[_rightButton(==30)]-20-|"];
    [constraints addObject:@"H:|-[_rightButton(95)]-20-|"];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (self.nextPageIndex == [self numberOfPages] - 1) {
        ...
        [self.rightButton setBackgroundImage:[UIImage imageNamed:@"skipIntroNonColor.png"] forState:UIControlStateNormal];
    }else {
        [self.rightButton setBackgroundImage:[UIImage imageNamed:@"skipIntroNon.png"] forState:UIControlStateNormal];
    }
